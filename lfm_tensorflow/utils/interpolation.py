...
parser.add_argument('-n','--name', default='Test', help='Name of the vector.')
...
zpath = r"./3D-Generation/" + args.name + "_zvectors.npy"
print("Path: " + zpath)
savename = "./3D-Generation/" + args.name + "_interpolated"
...
#  low = np.ones(200)
#  high = np.arange(200)
	lerpResult = slerp(i, z1, z2)
	#print("Slerp shape " + str(slerpRes.shape))

#try lerp instead
	#lerpResult = lerp(i, z1, z2)
	#print ("i in current_val at "+ str(i))

	interpolated = lerpResult.reshape((200, 1))
